...
# Load train dataset
train_path = 'archive/train.csv'  # Replace with the actual path
train_data = pd.read_csv(train_path)

# Load test dataset
test_path = 'archive/test.csv'  # Replace with the actual path
test_data = pd.read_csv(test_path)

# Load features dataset
features_path = 'archive/features.csv'  # Replace with the actual path
features_data = pd.read_csv(features_path)

# Load store dataset
store_path = 'archive/stores.csv'  # Replace with the actual path
